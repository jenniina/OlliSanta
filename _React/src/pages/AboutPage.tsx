...
const AboutPage: FC<Props> = ({ heading }) => {
  ...
  const videos: Partial<Video>[] = [
    ...
    },
    {
      ...
      url: "https://www.youtube-nocookie.com/embed/3a_yBpMX0DM",
  ...
  return (
    <>
      ...
      />
      {/* Preconnect to YouTube privacy-enhanced domain to speed up video loads */}
      <Helmet>
      ...
      <div ref={divRef} className={`${styles["tra"]}`}>
        ...
        <section>
          ...
          <div className={`btn-wrap btn-4`}>
            ...
            >
              {t("arrangements")}{" "}
              <TfiAngleDoubleDown style={{ fontSize: "0.8em" }} />
            </button>
            <button
              onClick={() => {
